package com.github.jakicdong.techub.service.shortlink.service.impl;
...
import com.github.jakicdong.techub.service.shortlink.help.ShortCodeGenerator;
import com.github.jakicdong.techub.service.shortlink.help.SourceDetector;
import com.github.jakicdong.techub.service.shortlink.repository.entity.ShortLinkDO;
import com.github.jakicdong.techub.service.shortlink.repository.entity.ShortLinkRecordDO;
import com.github.jakicdong.techub.service.shortlink.repository.mapper.ShortLinkMapper;
import com.github.jakicdong.techub.service.shortlink.repository.mapper.ShortLinkRecordMapper;
import com.github.jakicdong.techub.service.shortlink.service.ShortLinkService;
...
public class ShortLinkServiceImpl implements ShortLinkService {
    ...
    public ShortLinkVO createShortLink(ShortLinkDTO shortLinkDTO) throws NoSuchAlgorithmException {
        ...
        //https://www.example.com/article/123  ->	/article/123
    ...
    private String generateUniqueShortCode(String path) throws NoSuchAlgorithmException {
        ...
        if (generateTime >= 3 && null != shortLinkMapper.getByShortCode(shortCode)) {
