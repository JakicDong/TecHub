...
public class SpringUtil  implements ApplicationContextAware, EnvironmentAware {
    ...
    private volatile static ApplicationContext context; //存储spring上下文环境
    private volatile static Environment environment; //存储spring环境实例

    private static Binder binder; //用于配置属性绑定的binder实例
