package com.github.jakicdong.techub.core.senstive.ibatis;
...
/*
* @author JakicDong
* @description 敏感词读取拦截器 敏感词替换拦截器，这里主要是针对从db中读取的数据进行敏感词处理 （如果需要在写入db时，进行脱敏如加密，也可以使用类似的方式来实现）
* @time 2025/9/20 19:02
*/
@Intercepts({
