...
import com.github.jakicdong.techub.api.model.exception.NoVlaInGuavaException;
...
/*
 * @author JakicDong
 * @description 微信登录的辅助类
 * @time 2025/7/11 15:00
 */
@Slf4j
@Component
public class WxLoginHelper {
    ...
    public SseEmitter subscribe() throws IOException {
        ...
        String realCode = deviceCodeCache.getUnchecked(deviceId) ;//获取缓存验证码,不需要异常处理
    ...
    public String refreshCode() throws IOException {
        ...
        log.info("生成了一个新的验证码! deviceId:{}, oldCode:{}, code:{}", deviceId, oldCode, newCode);
